...
#define SIG_OS (1 << 1)
#define SIG_NONE 0
#define SIG_ALL (1 << 3) //<----this is dangerous
...
SIGNAL(BEFORE_SLEEP, SIG_IMMEDIATE, SIG_RUNTIME, 0)
SIGNAL(WAKE_AFTER, SIG_ALL, SIG_RUNTIME, 0)
SIGNAL(SYS_BROKE, SIG_IMMEDIATE, SIG_RUNTIME, 0)
SIGNAL(SYS_MSG, SIG_IMMEDIATE, SIG_RUNTIME, 0)
SIGNAL(ALLOW_LOOP, SIG_NONE, SIG_RUNTIME, 0)
SIGNAL(NO_MORE_OP, SIG_ALL, SIG_RUNTIME, 0)
SIGNAL(DBG_MODE, SIG_ALL, SIG_POWERLOSS, 0)
SIGNAL(BAT, SIG_ALL, SIG_POWERLOSS, 0)
SIGNAL(PWR_USB, SIG_ALL, SIG_POWERLOSS, 0)
SIGNAL(OTA, SIG_ALL, SIG_RUNTIME, 0)
SIGNAL(OTA_REQ, SIG_ALL, SIG_POWERLOSS, 0)
...
SIGNAL(APP_UPT_STATE, SIG_IMMEDIATE, SIG_RUNTIME, 0)
...
SIGNAL(APP_3PT_NUPD, SIG_NONE, SIG_RUNTIME, 0) //calculated onsite
SIGNAL(APP_3PT_NRUN, SIG_NONE, SIG_RUNTIME, 0) //calculated onsite

//force update
SIGNAL(UPD_REQ, SIG_ALL, SIG_POWERLOSS, 0)
