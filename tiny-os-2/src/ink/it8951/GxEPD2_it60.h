...
public:
  ...
  void beginWriteNative(int16_t x, int16_t y, int16_t w, int16_t h);
  void writeChunk(const uint8_t *data1, int16_t len);
  void writeSingleByte(uint8_t b);
  void writeChunkRGB(const uint16_t *data1, int16_t len);
  void endWriteNative(int16_t x, int16_t y, int16_t w, int16_t h);
  void endWriteNativeNoRefresh();
  ...
  void refresh(int16_t x, int16_t y, int16_t w, int16_t h, bool partial_update_mode);
